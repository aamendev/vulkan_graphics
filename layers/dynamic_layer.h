#ifndef DYNAMIC_COLLISION_H
#define DYNAMIC_COLLISION_H
...
namespace Lina { namespace Graphics {
    class DynamicCollisionLayer : public Layer
    {
        public:
            DynamicCollisionLayer(Renderer* r, Window* w): mWindow(w), mRenderer(r){}
        public:
            void init() override;
            void run() override;
        public:
